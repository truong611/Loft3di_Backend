...
{
    public class SendEmailPersonCreateRequest : BaseRequest<SendEmailPersonCreateParameter>
    {
        ...
        public override SendEmailPersonCreateParameter ToParameter()
        {
            return new SendEmailPersonCreateParameter()
            {
                CreateId = CreateId,
