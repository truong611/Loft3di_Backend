...
{
    public class CreateNoteForQuoteDetailRequest : BaseRequest<CreateNoteForQuoteDetailParameter>
    {
        public NoteModel Note { get; set; }
        public List<NoteDocumentModel> ListNoteDocument { get; set; }

        public override CreateNoteForQuoteDetailParameter ToParameter()
        {
            ...
            return new CreateNoteForQuoteDetailParameter()
            {
                Note = Note.ToEntity(),
