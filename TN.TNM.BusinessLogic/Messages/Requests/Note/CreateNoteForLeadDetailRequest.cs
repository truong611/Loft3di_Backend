...
{
    public class CreateNoteForLeadDetailRequest : BaseRequest<CreateNoteForLeadDetailParameter>
    {
        public NoteModel Note { get; set; }
        public List<NoteDocumentModel> ListNoteDocument { get; set; }
        public override CreateNoteForLeadDetailParameter ToParameter()
        {
            ...
            return new CreateNoteForLeadDetailParameter()
            {
                Note = Note.ToEntity(),
