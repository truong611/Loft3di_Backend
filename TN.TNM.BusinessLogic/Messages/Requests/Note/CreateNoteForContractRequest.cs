...
{
    public class CreateNoteForContractRequest : BaseRequest<CreateNoteForContractParameter>
    {
        public NoteModel Note { get; set; }
        public List<NoteDocumentModel> ListNoteDocument { get; set; }
        public string ObjType { get; set; }
        public string DescriptionReject { get; set; }
        public override CreateNoteForContractParameter ToParameter()
        {
            ...
            return new CreateNoteForContractParameter()
            {
                Note = Note.ToEntity(),
