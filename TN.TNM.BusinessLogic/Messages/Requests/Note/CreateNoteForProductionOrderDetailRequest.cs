...
{
    public class CreateNoteForProductionOrderDetailRequest : BaseRequest<CreateNoteForProductionOrderDetailParameter>
    {
        public NoteModel Note { get; set; }
        public List<NoteDocumentModel> ListNoteDocument { get; set; }
        public override CreateNoteForProductionOrderDetailParameter ToParameter()
        {
            ...
            return new CreateNoteForProductionOrderDetailParameter()
            {
                Note = Note.ToEntity(),
