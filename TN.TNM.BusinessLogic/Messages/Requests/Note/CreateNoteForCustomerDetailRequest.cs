...
{
    public class CreateNoteForCustomerDetailRequest : BaseRequest<CreateNoteForCustomerDetailParameter>
    {
        public NoteModel Note { get; set; }
        public List<NoteDocumentModel> ListNoteDocument { get; set; }

        public override CreateNoteForCustomerDetailParameter ToParameter()
        {
            ...
            return new CreateNoteForCustomerDetailParameter()
            {
                Note = Note.ToEntity(),
