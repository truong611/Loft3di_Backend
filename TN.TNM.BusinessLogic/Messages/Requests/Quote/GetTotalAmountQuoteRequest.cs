...
{
    public class GetTotalAmountQuoteRequest : BaseRequest<GetTotalAmountQuoteParameter>
    {
        public Guid PersonInChangeId { get; set; }
        public int MonthQuote { get; set; }
        public int YearQuote { get; set; }

        public override GetTotalAmountQuoteParameter ToParameter()
        {
            return new GetTotalAmountQuoteParameter
            {
