...
{
    public class NotifiSettingEntityModel : BaseModel<DataAccess.Databases.Entities.NotifiSetting>
    {
        ...
        public NotifiSettingEntityModel()
        {

        }

        public NotifiSettingEntityModel(Databases.Entities.NotifiSetting model)
        {
            Mapper(model, this);
        }
